      ...
      <div className="max-w-[1140px]  mx-auto md:px-10 xl:px-2 sm:px-2 px-4 flex flex-row gap-2  pb-40">
        <div className="w-[770px] h-[920px]  ">
          ...
          <form className="pt-8">
            ...
            <label
              htmlFor="forcheckbox"
              className="text-zinc2  font-medium  text-[16px]  leading-normal "
            >
              {" "}
              Keep me up to data on news and exclusive offers
            </label>
            <br />
            <h1
              className=" text-blue3  font-bold  text-[18px]  leading-normal pt-20
            "
            >
              Shipping address
            </h1>
            ...
            <button className="bg-pink w-[182px] h-[44px] text-white  mt-28  font-semibold text-[16px] font-josefin">
              Continue Shipping
            </button>
          </form>
        </div>
        <div className="w-[369px] h-[920px] flex flex-col gap-2 ">
          ...
          <div className="w-[371px] h-[284px] mt-10 flex flex-col gap-8 justify-center items-center">
            <div className="flex flex-row gap-32 items-center w-[310px] h-[30px] border border-zinc2 border-t-0 border-l-0 border-r-0 ">
              <p className="w-[79px] text-blue3  font-bold  text-[18px]  leading-normal">
                Subtotals:
              </p>
              <p className="w-[79px] text-blue3  font-normal  text-[16px]  leading-normal">
                £325.00
              </p>
            </div>
            ...
            <form className=" ml-8">
              ...
              <button className="bg-green w-[182px] h-[44px] text-white mt-11 font-semibold relative left-14 text-[16px] font-josefin">
                Proceed To Checkout
              </button>
            </form>
          </div>
