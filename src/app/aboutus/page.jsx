...
const page = () => {
  ...
  return (
    <div>
      ...
      <OurOffers />
      <h1 className=" text-black  font-bold  text-[36px]  leading-normal mt-[125px] text-center">
          {" "}
          Our Client Say!
        </h1>
      ...
      <div className=" inline-flex items-center justify-center gap-[29px] w-[1168px] h-[365px]  ">
        ...
        <p className=" w-[689px]  text-lightpurple  font-semibold  text-[14px]  leading-[26px]  text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non duis ultrices quam vel dui sollicitudin<br/> aliquet id arcu. Nam vitae a enim nunc, sed sapien egestas ac nam. Tristique ultrices dolor<br/> aliquam lacus volutpat praesent.</p>
       </div>
       </div>
       </div>
       <div className=" inline-flex items-center justify-center gap-[29px] w-full h-[365px]  ">
       ...
       <div className="w-[91px] h-1  flex justify-start items-center gap-1 mx-auto  mt-12">
      <button
