  ...
  return (
   ...
   ">
    ...
    px-4">
      ...
      <div className="flex  justify-center items-center gap-11 mx-auto w-[1168px] xl:px-20 px-4">
        <div className=" w-[370px] h-[270px]   hover:bg-white pt-5  ">
        ...
        <div  className=" w-[430px] h-[270px] hover:bg-white pt-5">
            <h1 className="text-[26px] leading-[26px] font-josefin text-blue font-bold ml-5">23% off in all products</h1>
            <div className="flex flex-row  mt-5">
                ...
                <Image src="/images/desk.png" width={242} height={171} alt="oclock" className="mt-7 b"/>
            </div>
        </div>
        <div className=" w-[420px] h-[270px]   hover:bg-white flex flex-col gap-7 pt-5">
