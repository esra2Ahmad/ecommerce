  ...
  return (
    <div >
      ...
      <div className="h-[286px]  w-full    bg-medviolet mt-10 mb-[124px]">
        <div className="max-w-[1140px] mx-auto md:px-10 sm:px-2  flex flex-col  gap-2 ">
      ...
      <div className=" max-w-[1140px]  mx-auto  md:px-10 xl:px-2 sm:px-2 flex flex-row gap-2">
      ...
      <div className="flex flex-row gap-24 py-32 max-w-[1140px] mx-auto md:px-10 xl:px-2 sm:px-2  ">
